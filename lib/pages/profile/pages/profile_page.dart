    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          buildUserInfoDisplay('Duc', 'Name', EditNameFormPage()),
          buildUserInfoDisplay('123456789', 'Phone', EditPhoneFormPage()),
          buildUserInfoDisplay('duc@gmail.com', 'Email', EditEmailFormPage()),
          // Expanded(
          //   flex: 4,
